...
use Ebay\Commerce\Catalog\Model\ProductSearchResponse as ProductSearchResponse;
use OpenAPI\Runtime\AbstractAPI as AbstractAPI;

class ProductSummary extends AbstractAPI
{
    /**
    ...
    {
        return $this->client->request('search', 'GET', 'product_summary/search',
            [
                'query' => $queries,
            ]
        );
