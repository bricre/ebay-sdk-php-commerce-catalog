# (Unofficial) eBay API client (PHP) - Commerce / Catalog
...
Please refer to [eBay's documentation](https://developer.ebay.com/api-docs/commerce/catalog/overview.html) for detailed API
...
Starting from version v1_beta.5.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/commerce/catalog/v1_beta/',
        'headers'=>[
